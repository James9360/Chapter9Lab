...
public class Question3 
{
	 ...
	 */
	public static TeamLeader getInput()
	{
		Scanner keyboard = new Scanner (System.in);
		String name, staffId;
		int day, month, year, numTrainingHours, requiredTrainingHours, shift;
		double hourlySalary, bonus;
		...
		System.out.print("Enter your monthly bonus: ");
		bonus = keyboard.nextDouble();
		System.out.print("Enter the number of hours trained: ");
		numTrainingHours = keyboard.nextInt();
		System.out.print("Enter the number of hours needed: ");
		requiredTrainingHours = keyboard.nextInt();
		...
		Date date = c.getTime();
		return new TeamLeader(name, staffId, date, shift, hourlySalary, bonus, numTrainingHours, requiredTrainingHours);
	}
